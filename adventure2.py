...
# def wrongChoice(section):
#     first = (input('Try again! Press 1 or 2.'))
#     restart = section
#     restart(first)


# def wrongChoiceItem(section, item):
#     first = (input('Try again! Press 1 or 2.'))
#     restart = section
#     restart(first, item)
...
def startGame():
    ...
    # valid_input(enterCave, startGame)
...
def enterCave(choice):
    if choice == "1" or choice == 1:
        ...
        valid_input(dagger, enterCave)
        # second = (input('Make your choice!'))
        # dagger(second)

    # else:
    #     valid_input(enterCave)
...
def portal(choice):
    if choice == "1" or choice == 1:
        ...
        valid_input(portalItem, portal, equipment)
...
def dagger(choice):
    if choice == "1" or choice == 1:
        ...
        valid_input(itemG, dagger, goblinItem)
